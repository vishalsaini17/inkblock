...
<body class="indicator-true" id="creativity">
    ...
    <div class="body-wrapper" onload="scrollDown()">
                ...
                <div class="row creativity">
                    <div class="col-md-9 mt-3">
                        <h1 id="creative-heading">
                            Let’s dive <br class="mobile-br"> into <br class="desktop-only-br">
                    ...
                    <div class="quote-btn col-12">
                        <a href="index#contact" class="btn my-btn">GET A QUOTE</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="who-we-are ">
            <div class="my-container what-we-padding">
                <div class="row align-items-center ">
                    <div class="col-12 col-6 col-md-6 col-md px-0">
                        <div class="col-12 wwa-right d-flex align-items-center pr-0">
                            <div class="col-12 px-0">
                                <h3>Who we are<span>...</span></h3>
                                <p><span> Ink Block Studio </span>is an India based creative design agency built by
                                    experienced design enthusiasts with the main focus in helping you grow your brand.
                                </p>
        ...
        <section class="work-section " id="work">
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            while($row = mysqli_fetch_assoc($result)) {
               ...
               $index=$row['index']; 
          ?>
                        <li><a href="project.php" class="projects-link" data-name='<?php echo $project_name ?>'
                                alise='<?php echo $catagory_name ?>'
                                data-index=<?php echo $index ?>><?php echo $project_name ?>
                                <small><?php echo $catagory_name ?></small></a></li>
                        ...
                        <div class="work-item__image">
                            <div class="mask">
                                <div class="image-container"
                                    style='background-image: url("projects/<?php echo $cover_image ?>")'></div>
                            </div>
                        </div>
                ...
                <div class="row creativity align-items-center">
                    <div class="col-12 col-md-5">
                        ...
                        <form action="#" class="col-12 col-lg-11 px-0 pt-4" id="contact-form" name="myForm">
                            <div class="form-row contact-form">
                                <div class="col-12 col-md-6 form-group">
                                    <input type="text" class="form-control your-name" placeholder="Name"
                                        name="your_name">
                                ...
                                <div class="col-12 col-md-6 form-group">
                                    <input type="number" class="form-control phone-number" placeholder="Phone"
                                ...
                                <div class="col-12 col-md-6 form-group" data-toggle="dropdown">
                                    <div class="d-flex form-menu">
                                        <input type="text" autocomplete="off" class="form-control"
                                            placeholder="How did you find us" name="found_us">
                      ...
                      Please enter valid phone number.
                                ...
                                <div class="col-12 form-group contact-form-btn mt-4 d-mb-none">
                    ...
                    <div class="col-12 col-md text-right contact-img d-mb-none">
